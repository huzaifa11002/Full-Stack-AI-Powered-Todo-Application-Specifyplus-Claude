...
*/}}
{{- define "todo-chatbot.component.fullname" -}}
{{- $componentName := index . 0 }}
{{- $context := index . 1 }}
{{- printf "%s-%s" (include "todo-chatbot.fullname" $context) $componentName | trunc 63 | trimSuffix "-" }}
{{- end }}
...
*/}}
{{- define "todo-chatbot.component.selectorLabels" -}}
{{- $componentName := index . 0 }}
{{- $context := index . 1 }}
app.kubernetes.io/name: {{ include "todo-chatbot.name" $context }}
